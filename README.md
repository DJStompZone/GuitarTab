...
## Post-processing
This script performs post-processing on the predictions generated by `inference.py`.
### Arguments
...
- `--method`  
  Post-processing method to apply. Options:
  - `fret`
  - `reverse`

- `--output-format`  
  Token format used by the model (`v1`, `v2`, `v3`).  
  See [docs/UPDATES.md](docs/UPDATES.md) for format details.
