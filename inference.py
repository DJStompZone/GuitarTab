...
def main(cfg: DictConfig):
    ...
    # print("Train input vocab size :", train_dataset.input_vocab.vocab_size)
    # print("Train output vocab size:", train_dataset.output_vocab.vocab_size)
    # print("Test  input vocab size :", dataset.input_vocab.vocab_size)
    # print("Test  output vocab size:", dataset.output_vocab.vocab_size)

    # sample_tokens = ["NOTE_ON_60", "NOTE_OFF_60", "TIME_SHIFT_10", "TAB_1_3"]
    # for tok in sample_tokens:
    #     print(f"{tok}:")
    #     print("  train input id :", train_dataset.input_vocab.token_to_id.get(tok))
    #     print("  test  input id :", dataset.input_vocab.token_to_id.get(tok))
    #     print("  train output id:", train_dataset.output_vocab.token_to_id.get(tok))
    #     print("  test  output id:", dataset.output_vocab.token_to_id.get(tok))
    # breakpoint()
